...
class Molecules {
    ...
    class func sugarMolecule() -> SCNNode {
        ...
        let hydrogenNode1 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(0, 2, 0))
        let hydrogenNode2 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(2, -2, 0))
        let hydrogenNode3 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(-2, -2, 0))
        let hydrogenNode4 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(-4, 2, 0))
        let hydrogenNode5 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(-4, 0, 2))
        let hydrogenNode6 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(4, 2, 0))
        let hydrogenNode7 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(6, -2, 0))
        let hydrogenNode8 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(-1.5, 0, 0))
        let hydrogenNode9 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(-1.5, 0, 0))
        let hydrogenNode10 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(-1.5, 0, 0))
        let hydrogenNode11 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(-1.5, 0, 0))
        let hydrogenNode12 = nodeWithAtom(Atoms.hydrogenAtom(), molecule: sugarMolecule, position: SCNVector3Make(-1.5, 0, 0))
